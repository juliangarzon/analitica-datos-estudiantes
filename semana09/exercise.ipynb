 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    color=___,  # Choose a single, professional color (e.g., 'steelblue', '#2C3E50')\n",
    "    edgecolor='none'\n",
    ")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "ax.plot(monthly_data['Month'], monthly_data['Target'],\n",
    "        linestyle='--', linewidth=1.5, color=___,  # Use a light gray\n",
    "        label='Target')\n",
    "\n",
    "# Plot actual execution (prominent)\n",
    "ax.plot(monthly_data['Month'], monthly_data['Execution_Rate'],\n",
    "        linestyle='-', linewidth=2.5, color=___,  # Use a professional blue\n",
    "        label='Actual')\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "colors = [___ if val >= target else ___ for val in sorted_dept['Execution_Pct']]\n",
